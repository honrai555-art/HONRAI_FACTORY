...
$inputDir = Join-Path $blenderDir "input_assets"
$outputDir = Join-Path $blenderDir "output_assets"
...
$notifyScript = Join-Path $projectRoot "scripts\notify_blender_build.py"
$importScript = Join-Path $projectRoot "scripts\import_generated_assets.ps1"
